        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8 mb-12">
          ...
          <div>
            ...
            <ul className="space-y-2 text-sm">
              <li>
                <Link href="/categories/electronics" className="hover:text-blue-400 transition">
                  Electronics
                </Link>
              </li>
              <li>
                <Link href="/categories/fashion" className="hover:text-blue-400 transition">
                  Fashion
                </Link>
              </li>
              <li>
                <Link href="/categories/home" className="hover:text-blue-400 transition">
                  Home & Garden
                </Link>
              </li>
              <li>
                <Link href="/categories/books" className="hover:text-blue-400 transition">
                  Books
                </Link>
              </li>
              <li>
                <Link href="/sale" className="hover:text-blue-400 transition">
                  Sale
                </Link>
              </li>
            </ul>

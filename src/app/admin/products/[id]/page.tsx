...
export default function ProductForm() {
  ...
  return (
    <div>
      <Link href="/admin/products" className="text-amber-600 hover:text-blue-800 font-semibold mb-6 inline-block">
        ← Torna ai Prodotti
      </Link>
      ...
      <form onSubmit={handleSubmit} className="bg-white rounded-lg shadow p-8 max-w-2xl">
        ...
        <div className="flex gap-4">
          <button
            type="submit"
            className="flex-1 bg-slate-900 hover:bg-amber-700 text-white font-semibold py-3 rounded-lg transition"
          >

      ...
      <div className="w-full max-w-md">
        ...
        <div className="bg-white rounded-2xl shadow-xl p-8">
          ...
          <div className="text-center mb-8">
            ...
            <p className="text-gray-600">Sign in to your StoreLux account</p>
          </div>
          ...
          <div className="space-y-3">
            <button className="w-full border border-gray-300 hover:bg-gray-50 text-gray-900 font-medium py-2 rounded-lg transition flex items-center justify-center gap-2">
